...
"""
Description: Train HT online and validate in online (learn_one + predict_one) mode.
"""
...
RESULTS_DIR   = "./ht_results_streaming"       # <── change as needed
...
for i, (x, y) in enumerate(rtr_val):
    ...
    val_rec.update(y, yp)
    ht.learn_one(x, y) # ← online update: so that the model can adapt to new data
